...
public class ItemController {
    ...
    public String updateItem(@ModelAttribute Item updatedItem,
        ...
        String result = itemService.updateItem(updatedItem, attributes, photos != null ? photos : new MultipartFile[0],
                colorId, materialId, makerId, modelId, photosToDeleteList, city, street, house);
    ...
    public String createItemForm(@RequestParam(name = "category", required = true) Long category, Model model) {
        ...
        attributes.put("cities", cityService.getCities());
        model.addAllAttributes(attributes);
        return "createItem";
    }
    ...
    public String saveItem(@ModelAttribute Item newItem,
        ...
        String address = String.format("%s, %s, %s", city, street, house);
